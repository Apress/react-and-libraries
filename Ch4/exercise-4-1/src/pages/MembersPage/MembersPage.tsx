...
export default class MembersPage extends React.PureComponent<IMembersPageProps, IMembersPageState> {
  ...
  static getDerivedStateFromProps: React.GetDerivedStateFromProps<IMembersPageProps, IMembersPageState> = (props: IMembersPageProps, state: IMembersPageState) => {
    // invoked right before calling the render method, both on the initial mount and on subsequent updates
    // return an object to update the state, or null to update nothing.
    return null
  }

  public getSnapshotBeforeUpdate(prevProps: IMembersPageProps, prevState: IMembersPageState) {
    // invoked right before the most recently rendered output is committed
    // A snapshot value (or null) should be returned.
    return null
  }

  componentDidUpdate(prevProps: IMembersPageProps, prevState: IMembersPageState, snapshot: IMembersPageSnapshot) {
    // invoked immediately after updating occurs. This method is not called for the initial render.
    // will not be invoked if shouldComponentUpdate() returns false.
  }

  render() {
    return <div className="MembersPage">{this.state.name} Component</div>
  }
}
...
interface IMembersPageSnapshot {
  // TODO
}
